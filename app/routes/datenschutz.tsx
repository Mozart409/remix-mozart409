...
export default function Datenschutz() {
  return (
    <div className="prose prose-lg mx-auto prose-headings:underline prose-a:text-primary-600 md:prose-lg lg:prose-2xl">
      ...
      <p>
        CMS: Google Ireland Limited Gordon House, Barrow Street Dublin 4 Irland
        Tel: +353 1 543 1000 Fax: +353 1 686 5660 E-Mail:
      ...
      <p>
        Wir nutzen das Content Delivery Network Amazon CloudFront CDN. Anbieter
        ist die Amazon Web Services EMEA SARL, 38 avenue John F. Kennedy,
        L-1855, Luxemburg (nachfolgend „Amazon“).
      </p>
      <p>
        Bei Amazon CloudFront CDN handelt es sich um ein weltweit verteiltes
        Content Delivery Network. Dabei wird technisch der Informationstransfer
        zwischen Ihrem Browser und unserer Website über das Content Delivery
        Network geleitet. Hierdurch können wir die weltweite Erreichbarkeit und
      ...
      <p>
        ...
        Google Analytics u.&nbsp;a. Ihren Standort, Suchverlauf und
        YouTube-Verlauf sowie demografische Daten (Besucherdaten). Diese Daten
        können mit Hilfe von Google-Signal für personalisierte Werbung verwendet
        werden. Wenn Sie über ein Google-Konto verfügen, werden die
        Besucherdaten von Google-Signal mit Ihrem Google-Konto verknüpft und für
        personalisierte Werbebotschaften verwendet. Die Daten werden außerdem
        für die Erstellung anonymisierter Statistiken zum Nutzerverhalten
        unserer User verwendet.
      </p>
      <h4 id="auftragsverarbeitung">Auftragsverarbeitung</h4>
      <p>
      ...
      <p>
        ...
        Website. Mit Hotjar können wir u.&nbsp;a. Ihre Maus- und
      ...
      <p>
        ...
        verwendet werden können. Diese werden laut Google zur Bekämpfung von
        Betrug und Missbrauch eingesetzt.
      </p>
      <p>
      ...
      <p>
        ...
        Nutzungs- und Surfverhaltens auf einem Endgerät (z.&nbsp;B. Handy) an
        Sie angepasst wurden auch auf einem anderen Ihrer Endgeräte (z.&nbsp;B.
      ...
      <p>
        ...
        (z.&nbsp;B. E-Mail-Adressen) aus unseren Kundenlisten an Google. Sind
        die betreffenden Kunden Google-Nutzer und in ihrem Google-Konto
      ...
      <p>
        ...
        Facebook. Anbieter dieses Dienstes ist die Meta Platforms Ireland
      ...
      <p>
        ...
        geräteübergreifend erfolgen (z.&nbsp;B. von PC zu Tablet). LinkedIn
        Insight Tag bietet außerdem eine Retargeting-Funktion an, mit deren
        Hilfe wir den Besuchern unserer Website zielgerichtete Werbung außerhalb
        der Website anzeigen lassen können, wobei laut LinkedIn keine
      ...
      <p>
        Die Nutzung von LinkedIn Insight erfolgt auf Grundlage von Art. 6 Abs. 1
        lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an
        effektiven Werbemaßnahmen unter Einschluss der sozialen Medien. Sofern
        eine entsprechende Einwilligung abgefragt wurde, erfolgt die
        Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO
      ...
      <p>
        ...
        organisiert werden kann. Wenn Sie Daten zum Zwecke des Newsletterbezugs
        eingeben (z.&nbsp;B. E-Mail-Adresse), werden diese auf den Servern von
        MailChimp in den USA gespeichert. Wir haben die Erfolgsmessung bei
        Mailchimp deaktiviert, sodass Mailchimp ihr Verhalten beim Öffnen
        unserer Newsletter nicht auswerten wird.
      </p>
      <p>
        Wenn Sie nicht möchten, dass Ihre Daten an Mailchimp übertragen werden,
        müssen Sie den Newsletter abbestellen. Hierfür stellen wir in jeder
      ...
      <p>
        ...
        auf eine Werbeanzeige auf unserer Website klicken, die am
        Partnerprogramm teilnimmt und im Anschluss daran eine Transaktion
        (z.&nbsp;B. einen Kauf) tätigen, erhalten wir hierfür eine Vergütung von
        unseren Affiliate-Partnern. Dafür ist es erforderlich, dass unsere
        ...
        Hierfür setzen unsere Affiliate-Partner Cookies oder vergleichbare
      ...
      <p>
        Wir haben OneDrive auf dieser Website eingebunden. Anbieter ist die
        Microsoft Corporation, One Microsoft Way, Redmond, WA 98052-6399, USA
        (im folgenden „OneDrive“).
      </p>
      <p>
        OneDrive ermöglicht es uns, einen Uploadbereich auf unserer Website
        einzubinden, in dem Sie Inhalte hochladen können. Wenn Sie Inhalte
        hochladen, werden diese auf den Servern von OneDrive gespeichert. Wenn
        Sie unsere Website betreten, wird außerdem eine Verbindung zu OneDrive
        aufgebaut, sodass OneDrive feststellen kann, dass Sie unsere Website
        besucht haben.
      </p>
      <p>
        Die Verwendung von OneDrive erfolgt auf Grundlage von Art. 6 Abs. 1 lit.
        f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an einem
        zuverlässigen Uploadbereich auf seiner Website. Sofern eine
        entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung
