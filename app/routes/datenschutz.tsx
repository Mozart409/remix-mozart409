  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-prose md:mt-5 md:max-w-3xl prose prose-lg xl:prose-lg">
        ...
        <h4 id="wer-ist-verantwortlich-fuer-die-datenerfassung-auf-dieser-website">
        ...
        <h4 id="wofuer-nutzen-wir-ihre-daten">Wofür nutzen wir Ihre Daten?</h4>
        <p>
        ...
        <h4 id="welche-rechte-haben-sie-bezueglich-ihrer-daten">
        ...
        <h3 id="analyse-tools-und-tools-von-drittanbietern">
        ...
        <h2 id="2.-hosting-und-content-delivery-networks-(cdn)">
        ...
        <p>
          CMS: Google Ireland Limited Gordon House, Barrow Street Dublin 4 Irland Tel: +353 1 543 1000 Fax: +353 1 686
          5660 E-Mail: support-deutschland@google.com
        </p>
        <h4 id="auftragsverarbeitung">Auftragsverarbeitung</h4>
        <p>
        ...
        <h3 id="google-cloud-cdn">Google Cloud CDN</h3>
        <p>
          Wir nutzen das Content Delivery Network Google Cloud CDN. Anbieter ist die Google Ireland Limited („Google“),
          Gordon House, Barrow Street, Dublin 4, Irland.
        </p>
        <p>
          Google bietet ein weltweit verteiltes Content Delivery Network an. Dabei wird technisch der
          Informationstransfer zwischen Ihrem Browser und unserer Website über das Netzwerk von Google geleitet.
          Hierdurch können wir die weltweite Erreichbarkeit und die Leistungsfähigkeit unserer Website erhöhen.
        </p>
        <p>
          Der Einsatz von Google Cloud CDN beruht auf unserem berechtigten Interesse an einer möglichst fehlerfreien und
        ...
        <h3 id="amazon-cloudfront-cdn">Amazon CloudFront CDN</h3>
        <p>
          Wir nutzen das Content Delivery Network Amazon CloudFront CDN. Anbieter ist die Amazon Web Services EMEA SARL,
          38 avenue John F. Kennedy, L-1855, Luxemburg (nachfolgend „Amazon“).
        </p>
        <p>
          Bei Amazon CloudFront CDN handelt es sich um ein weltweit verteiltes Content Delivery Network. Dabei wird
          technisch der Informationstransfer zwischen Ihrem Browser und unserer Website über das Content Delivery
          Network geleitet. Hierdurch können wir die weltweite Erreichbarkeit und die Leistungsfähigkeit unserer Website
          erhöhen.
        </p>
        <p>
          Der Einsatz von Amazon CloudFront CDN beruht auf unserem berechtigten Interesse an einer möglichst
        ...
        <h2 id="3.-allgemeine-hinweise-und-pflichtinformationen">
        ...
        <h3 id="hinweis-zur-verantwortlichen-stelle">
        ...
        <h3 id="allgemeine-hinweise-zu-den-rechtsgrundlagen-der-datenverarbeitung-auf-dieser-website">
        ...
        <p>
          ...
          Endgerät (z.&nbsp;B. via Device-Fingerprinting) eingewilligt haben, erfolgt die Datenverarbeitung zusätzlich
        ...
        <h3 id="datenschutzbeauftragter">Datenschutz­beauftragter</h3>
        <p>
        ...
        <h3 id="hinweis-zur-datenweitergabe-in-die-usa-und-sonstige-drittstaaten">
        ...
        <p>
          ...
          hiergegen gerichtlich vorgehen könnten. Es kann daher nicht ausgeschlossen werden, dass US-Behörden
          (z.&nbsp;B. Geheimdienste) Ihre auf US-Servern befindlichen Daten zu Überwachungszwecken verarbeiten,
          auswerten und dauerhaft speichern. Wir haben auf diese Verarbeitungstätigkeiten keinen Einfluss.
        </p>
        <h3 id="widerruf-ihrer-einwilligung-zur-datenverarbeitung">
        ...
        <h3 id="widerspruchsrecht-gegen-die-datenerhebung-in-besonderen-faellen-sowie-gegen-direktwerbung-(art.-21-dsgvo)">
        ...
        <h3 id="beschwerderecht-bei-der-zustaendigen-aufsichtsbehoerde">
        ...
        <h3 id="recht-auf-datenuebertragbarkeit">
        ...
        <h3 id="ssl-bzw.-tls-verschluesselung">SSL- bzw. TLS-Verschlüsselung</h3>
        <p>
        ...
        <h3 id="auskunft-loeschung-und-berichtigung">
        ...
        <h3 id="recht-auf-einschraenkung-der-verarbeitung">
        ...
        <h3 id="widerspruch-gegen-werbe-e-mails">
        ...
        <h2 id="4.-datenerfassung-auf-dieser-website">
        ...
        <h3 id="einwilligung-mit-usercentrics">Einwilligung mit Usercentrics</h3>
        <p>
        ...
        <p>
          ...
          deren Widerruf zuordnen zu können. Die so erfassten Daten werden gespeichert, bis Sie uns zur Löschung
          auffordern, das Usercentrics-Cookie selbst löschen oder der Zweck für die Datenspeicherung entfällt. Zwingende
        ...
        <h3 id="anfrage-per-e-mail-telefon-oder-telefax">
        ...
        <p>
          Wir haben Google Forms auf dieser Website eingebunden. Anbieter ist die die Google Ireland Limited, Gordon
          House, Barrow Street, Dublin 4, Irland (nachfolgend Google).
        </p>
        <p>
          Google Forms ermöglicht es uns, Online-Formulare zu erstellen um Nachrichten, Anfragen und sonstige Eingaben
          unserer Websitebesucher strukturiert zu erfassen. Alle von Ihnen getätigten Eingaben werden auf den Servern
          von Google verarbeitet. Google Forms speichert ein Cookie in Ihrem Browser, das eine eindeutige ID enthält
          (NID-Cookie). Dieses Cookie speichert verschiedene Informationen wie beispielsweise Ihre Spracheinstellungen.
        </p>
        <p>
          Der Einsatz von Google Forms erfolgt auf Grundlage unseres berechtigten Interesses an einer möglichst
        ...
        <p>
          Die von Ihnen im Formular eingegebenen Daten verbleiben bei uns, bis Sie uns zur Löschung auffordern, Ihre
        ...
        <h3 id="calendly">Calendly</h3>
        <p>
          Auf unserer Website haben Sie die Möglichkeit, Termine mit uns zu vereinbaren. Für die Terminbuchung nutzen
          wir das Tool „Calendly“. Anbieter ist die Calendly LLC, 271 17th St NW, 10th Floor, Atlanta, Georgia 30363,
          USA (nachfolgend „Calendly“).
        </p>
        <p>
          Zum Zweck der Terminbuchung geben Sie die abgefragten Daten und den Wunschtermin in die dafür vorgesehene
          Maske ein. Die eingegebenen Daten werden für die Planung, Durchführung und ggf. für die Nachbereitung des
          Termins verwendet. Die Termindaten werden für uns auf den Servern von Calendly gespeichert, dessen
        ...
        <p>
          ...
          berechtigtes Interesse an einer möglichst unkomplizierten Terminvereinbarung mit Interessenten und Kunden.
          Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage
          von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder
          den Zugriff auf Informationen im Endgerät des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TTDSG
          umfasst. Die Einwilligung ist jederzeit widerrufbar.
        ...
        <h2 id="5.-analyse-tools-und-werbung">5. Analyse-Tools und Werbung</h2>
        ...
        <p>
          ...
          Betriebssysteme und Herkunft des Nutzers. Diese Daten werden dem jeweiligen Endgerät des Users zugeordnet.
          Eine Zuordnung zu einer Geräte-ID erfolgt nicht.
        </p>
        <p>
          Des Weiteren können wir mit Google Analytics u.&nbsp;a. Ihre Maus- und Scrollbewegungen und Klicks
          aufzeichnen. Ferner verwendet Google Analytics verschiedene Modellierungsansätze, um die erfassten Datensätze
        ...
        <h4 id="browser-plugin">Browser Plugin</h4>
        <p>
        ...
        <h4 id="google-signale">Google-Signale</h4>
        <p>
          Wir nutzen Google-Signale. Wenn Sie unsere Website besuchen, erfasst Google Analytics u.&nbsp;a. Ihren
          Standort, Suchverlauf und YouTube-Verlauf sowie demografische Daten (Besucherdaten). Diese Daten können mit
          Hilfe von Google-Signal für personalisierte Werbung verwendet werden. Wenn Sie über ein Google-Konto verfügen,
          werden die Besucherdaten von Google-Signal mit Ihrem Google-Konto verknüpft und für personalisierte
          Werbebotschaften verwendet. Die Daten werden außerdem für die Erstellung anonymisierter Statistiken zum
        ...
        <h4 id="google-analytics-e-commerce-messung">
          Google Analytics E-Commerce-Messung
        </h4>
        <p>
          Diese Website nutzt die Funktion „E-Commerce-Messung“ von Google Analytics. Mit Hilfe von E-Commerce-Messung
        ...
        <p>
          Hotjar ist ein Werkzeug zur Analyse Ihres Nutzerverhaltens auf dieser Website. Mit Hotjar können wir
        ...
        <p>
          ...
          haben. Wir können auch feststellen, an welcher Stelle Sie Ihre Eingaben in ein Kontaktformular abgebrochen
          haben (sog. Conversion-Funnels).
        </p>
        <p>
          Darüber hinaus können mit Hotjar direkte Feedbacks von Websitebesuchern eingeholt werden. Diese Funktion dient
        ...
        <p>
          Die Nutzung dieses Analysetools erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat
        ...
        <p>
          Wenn Sie die Datenerfassung durch Hotjar deaktivieren möchten, klicken Sie auf folgenden Link und folgen Sie
        ...
        <p>
          ...
          Werbeanzeigen anhand der bei Google vorhandenen Nutzerdaten (z.&nbsp;B. Standortdaten und Interessen)
          ausgespielt werden (Zielgruppen-Targeting). Wir als Websitebetreiber können diese Daten quantitativ auswerten,
          indem wir beispielsweise analysieren, welche Suchbegriffe zur Ausspielung unserer Werbeanzeigen geführt haben
          und wie viele Anzeigen zu entsprechenden Klicks geführt haben.
        </p>
        <p>
        ...
        <h3 id="google-adsense-(nicht-personalisiert)">
          Google AdSense (nicht personalisiert)
        </h3>
        <p>
          Diese Website nutzt Google AdSense, einen Dienst zum Einbinden von Werbeanzeigen. Anbieter ist die Google
          Ireland Limited („Google“), Gordon House, Barrow Street, Dublin 4, Irland.
        </p>
        <p>
          Wir nutzen Google AdSense im „nicht-personalisierten“ Modus. Im Gegensatz zum personalisierten Modus beruhen
          die Werbeanzeigen daher nicht auf Ihrem früheren Nutzerverhalten und es wird kein Nutzerprofil von Ihnen
          erstellt. Stattdessen werden bei der Auswahl der Werbung sogenannte „Kontextinformationen“ herangezogen. Die
          ausgewählten Werbeanzeigen richten sich dann beispielsweise nach Ihrem Standort, dem Inhalt der Website, auf
          der Sie sich befinden oder nach Ihren aktuellen Suchbegriffen. Mehr zu den Unterschieden zwischen
          personalisiertem und nicht-personalisiertem Targeting mit Google AdSense finden Sie unter:{" "}
          <a
        ...
        <p>
          Bitte beachten Sie, dass auch beim Einsatz von Google Adsense im nicht-personalisierten Modus Cookies oder
          vergleichbare Wiedererkennungstechnologien (z.&nbsp;B. Device-Fingerprinting) verwendet werden können. Diese
          werden laut Google zur Bekämpfung von Betrug und Missbrauch eingesetzt.
        </p>
        <p>
          Die Nutzung von AdSense erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein
          berechtigtes Interesse an einer möglichst effektiven Vermarktung seiner Website. Sofern eine entsprechende
          Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a
          DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf
          Informationen im Endgerät des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TTDSG umfasst. Die
          Einwilligung ist jederzeit widerrufbar.
        ...
        <p>
          Sie können Ihre Werbeeinstellungen selbstständig in Ihrem Nutzer-Account anpassen. Klicken Sie hierzu auf
        ...
        <h3 id="google-remarketing">Google Remarketing</h3>
        <p>
          Diese Website nutzt die Funktionen von Google Analytics Remarketing. Anbieter ist die Google Ireland Limited
          („Google“), Gordon House, Barrow Street, Dublin 4, Irland.
        </p>
        <p>
          Google Remarketing analysiert Ihr Nutzerverhalten auf unserer Website (z.&nbsp;B. Klick auf bestimmte
          Produkte), um Sie in bestimmte Werbe-Zielgruppen einzuordnen und Ihnen anschließend beim Besuch von anderen
          Onlineangeboten passende Webebotschaften auszuspielen (Remarketing bzw. Retargeting).
        </p>
        <p>
          Des Weiteren können die mit Google Remarketing erstellten Werbe-Zielgruppen mit den geräteübergreifenden
          Funktionen von Google verknüpft werden. Auf diese Weise können interessenbezogene, personalisierte
          Werbebotschaften, die in Abhängigkeit Ihres früheren Nutzungs- und Surfverhaltens auf einem Endgerät
          (z.&nbsp;B. Handy) an Sie angepasst wurden auch auf einem anderen Ihrer Endgeräte (z.&nbsp;B. Tablet oder PC)
          angezeigt werden.
        </p>
        <p>
          Wenn Sie über einen Google-Account verfügen, können Sie der personalisierten Werbung unter folgendem Link
          widersprechen:{" "}
          <a
        ...
        <p>
          Die Nutzung von Google Remarketing erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber
        ...
        <h4 id="zielgruppenbildung-mit-kundenabgleich">
          Zielgruppenbildung mit Kundenabgleich
        </h4>
        <p>
          Zur Zielgruppenbildung verwenden wir unter anderem den Kundenabgleich von Google Remarketing. Hierbei
          übergeben wir bestimmte Kundendaten (z.&nbsp;B. E-Mail-Adressen) aus unseren Kundenlisten an Google. Sind die
          betreffenden Kunden Google-Nutzer und in ihrem Google-Konto eingeloggt, werden ihnen passende Werbebotschaften
          innerhalb des Google-Netzwerks (z.&nbsp;B. bei YouTube, Gmail oder in der Suchmaschine) angezeigt.
        </p>
        <h3 id="google-conversion-tracking">Google Conversion-Tracking</h3>
        <p>
          Diese Website nutzt Google Conversion Tracking. Anbieter ist die Google Ireland Limited („Google“), Gordon
          House, Barrow Street, Dublin 4, Irland.
        </p>
        <p>
          Mit Hilfe von Google-Conversion-Tracking können Google und wir erkennen, ob der Nutzer bestimmte Aktionen
          durchgeführt hat. So können wir beispielsweise auswerten, welche Buttons auf unserer Website wie häufig
          geklickt und welche Produkte besonders häufig angesehen oder gekauft wurden. Diese Informationen dienen dazu,
          Conversion-Statistiken zu erstellen. Wir erfahren die Gesamtanzahl der Nutzer, die auf unsere Anzeigen
          geklickt haben und welche Aktionen sie durchgeführt haben. Wir erhalten keine Informationen, mit denen wir den
          Nutzer persönlich identifizieren können. Google selbst nutzt zur Identifikation Cookies oder vergleichbare
        ...
        <p>
          ...
          als auch seine Werbung zu optimieren. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die
        ...
        <h3 id="google-doubleclick">Google DoubleClick</h3>
        <p>
        ...
        <p>
          DoubleClick wird eingesetzt, um Ihnen interessenbezogene Werbeanzeigen im gesamten Google-Werbenetzwerk
          anzuzeigen. Die Werbeanzeigen können mit Hilfe von DoubleClick zielgerichtet an die Interessen des jeweiligen
          Betrachters angepasst werden. So kann unsere Werbung beispielsweise in Google-Suchergebnissen oder in
          Werbebannern, die mit DoubleClick verbunden sind, angezeigt werden.
        </p>
        <p>
          Um den Nutzern interessengerechte Werbung anzeigen zu können, muss DoubleClick den jeweiligen Betrachter
          ...
          zusammengefasst, um dem betreffenden Nutzer interessengerechte Werbung anzuzeigen.
        </p>
        <p>
          Die Nutzung von Google DoubleClick erfolgt im Interesse zielgerichteter Werbemaßnahmen. Dies stellt ein
          berechtigtes Interesse im Sinne des Art. 6 Abs. 1 lit. f DSGVO dar. Sofern eine entsprechende Einwilligung
        ...
        <p>
          Weitere Informationen zu Widerspruchsmöglichkeiten gegen die von Google eingeblendeten Werbeanzeigen entnehmen
          Sie folgenden Links:{" "}
          <a
            href="https://policies.google.com/technologies/ads"
            target="_blank"
        ...
        <p>
          Diese Website nutzt zur Konversionsmessung der Besucheraktions-Pixel von Facebook. Anbieter dieses Dienstes
          ist die Meta Platforms Ireland Limited, 4 Grand Canal Square, Dublin 2, Irland. Die erfassten Daten werden
        ...
        <p>
          ...
          Facebook-Werbeanzeigen für statistische und Marktforschungszwecke ausgewertet werden und zukünftige
        ...
        <p>
          ...
          verwenden kann. Dadurch kann Facebook das Schalten von Werbeanzeigen auf Seiten von Facebook sowie außerhalb
          von Facebook ermöglichen. Diese Verwendung der Daten kann von uns als Seitenbetreiber nicht beeinflusst
          werden.
        </p>
        <p>
          Die Nutzung von Facebook-Pixel erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat
          ein berechtigtes Interesse an effektiven Werbemaßnahmen unter Einschluss der sozialen Medien. Sofern eine
          entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6
          Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder den
          Zugriff auf Informationen im Endgerät des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TTDSG
          umfasst. Die Einwilligung ist jederzeit widerrufbar.
        ...
        <p>
          ...
          (z.&nbsp;B. Auskunftsersuchen) hinsichtlich der bei Facebook verarbeiteten Daten können Sie direkt bei
        ...
        <h3 id="linkedin-insight-tag">LinkedIn Insight Tag</h3>
        <p>
          Diese Website nutzt das Insight-Tag von LinkedIn. Anbieter dieses Dienstes ist die LinkedIn Ireland Unlimited
          Company, Wilton Plaza, Wilton Place, Dublin 2, Irland.
        </p>
        <h4 id="datenverarbeitung-durch-linkedin-insight-tag">
          Datenverarbeitung durch LinkedIn Insight Tag
        </h4>
        <p>
          Mit Hilfe des LinkedIn Insight Tags erhalten wir Informationen über die Besucher unserer Website. Ist ein
          Websitebesucher bei LinkedIn registriert, können wir u.&nbsp;a. die beruflichen Eckdaten (z.&nbsp;B.
          Karrierestufe, Unternehmensgröße, Land, Standort, Branche und Berufsbezeichnung) unserer Websitebesucher
          analysieren und so unsere Seite besser auf die jeweiligen Zielgruppen ausrichten. Ferner können wir mit Hilfe
          von LinkedIn Insight Tags messen, ob die Besucher unserer Webseiten einen Kauf oder eine sonstige Aktion
          tätigen (Conversion-Messung). Die Conversion-Messung kann auch geräteübergreifend erfolgen (z.&nbsp;B. von PC
          zu Tablet). LinkedIn Insight Tag bietet außerdem eine Retargeting-Funktion an, mit deren Hilfe wir den
          Besuchern unserer Website zielgerichtete Werbung außerhalb der Website anzeigen lassen können, wobei laut
        ...
        <p>
          ...
          zugeordnet werden. LinkedIn wird die erfassten personenbezogenen Daten der Websitebesucher auf seinen Servern
          in den USA speichern und sie im Rahmen eigener Werbemaßnahmen nutzen. Details entnehmen Sie der
        ...
        <h4 id="rechtsgrundlage">Rechtsgrundlage</h4>
        <p>
          Die Nutzung von LinkedIn Insight erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber
          hat ein berechtigtes Interesse an effektiven Werbemaßnahmen unter Einschluss der sozialen Medien. Sofern eine
          entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6
          Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder den
          Zugriff auf Informationen im Endgerät des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TTDSG
          umfasst. Die Einwilligung ist jederzeit widerrufbar.
        ...
        <h4 id="widerspruch-gegen-die-verwendung-von-linkedin-insight-tag">
          Widerspruch gegen die Verwendung von LinkedIn Insight Tag
        </h4>
        <p>
          Der Analyse des Nutzungsverhaltens sowie zielgerichtete Werbung durch LinkedIn unter folgendem Link
          widersprechen:{" "}
          <a
        ...
        <p>
          ...
          Kontoeinstellungen steuern. Um einer Verknüpfung von auf unserer Website erhobenen Daten durch LinkedIn und
          Ihrem LinkedIn Account zu vermeiden, müssen Sie sich aus Ihrem LinkedIn-Account ausloggen bevor Sie unsere
          Website aufsuchen.
        </p>
        <h2 id="6.-newsletter">6. Newsletter</h2>
        <h3 id="newsletterdaten">Newsletter­daten</h3>
        <p>
          ...
          E-Mail-Adresse und mit dem Empfang des Newsletters einverstanden sind. Weitere Daten werden nicht bzw. nur auf
          freiwilliger Basis erhoben. Für die Abwicklung der Newsletter nutzen wir Newsletterdiensteanbieter, die
          nachfolgend beschrieben werden.
        </p>
        <h3 id="mailchimp-mit-deaktivierter-erfolgsmessung">
        ...
        <p>
          MailChimp ist ein Dienst, mit dem u.a. der Versand von Newslettern organisiert werden kann. Wenn Sie Daten zum
          Zwecke des Newsletterbezugs eingeben (z.&nbsp;B. E-Mail-Adresse), werden diese auf den Servern von MailChimp
          in den USA gespeichert. Wir haben die Erfolgsmessung bei Mailchimp deaktiviert, sodass Mailchimp ihr Verhalten
          beim Öffnen unserer Newsletter nicht auswerten wird.
        </p>
        <p>
          Wenn Sie nicht möchten, dass Ihre Daten an Mailchimp übertragen werden, müssen Sie den Newsletter abbestellen.
        ...
        <p>
          ...
          des Newsletters aus der Newsletterverteilerliste gelöscht. Daten, die zu anderen Zwecken bei uns gespeichert
        ...
        <p>
          ...
          Daten zusammengeführt. Dies dient sowohl Ihrem Interesse als auch unserem Interesse an der Einhaltung der
          gesetzlichen Vorgaben beim Versand von Newslettern (berechtigtes Interesse im Sinne des Art. 6 Abs. 1 lit. f
        ...
        <h2 id="7.-plugins-und-tools">7. Plugins und Tools</h2>
        ...
        <p>
          ...
          der einheitlichen Darstellung der Schriftarten Google Web Fonts verwenden. Beim Aufruf von Google Maps lädt
        ...
        <h2 id="8.-online-marketing-und-partnerprogramme">
          8. Online-Marketing und Partner­programme
        </h2>
        <h3 id="affiliate-programme-auf-dieser-website">
          Affiliate-Programme auf dieser Website
        </h3>
        <p>
          Der Websitebetreiber nimmt an Affiliate-Partnerprogrammen teil. Wenn Sie auf eine Werbeanzeige auf unserer
          Website klicken, die am Partnerprogramm teilnimmt und im Anschluss daran eine Transaktion (z.&nbsp;B. einen
          Kauf) tätigen, erhalten wir hierfür eine Vergütung von unseren Affiliate-Partnern. Dafür ist es erforderlich,
          dass unsere Affiliate-Partner Sie identifizieren und nachvollziehen können, dass Sie über die bei uns
          platzierte Werbeanzeige auf das jeweilige Produkt gekommen sind und die vordefinierte Transaktion vorgenommen
          haben. Hierfür setzen unsere Affiliate-Partner Cookies oder vergleichbare Wiedererkennungstechnologien
          (z.&nbsp;B. Device-Fingerprinting) ein.
        </p>
        <p>
          Die Speicherung und Analyse der Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der
          Websitebetreiber hat ein berechtigtes Interesse an der korrekten Berechnung seiner Affiliate-Vergütung. Sofern
          eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von
          Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TTDSG, soweit die Einwilligung die Speicherung von Cookies oder den
          Zugriff auf Informationen im Endgerät des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne des TTDSG
          umfasst. Die Einwilligung ist jederzeit widerrufbar.
        </p>
        ...
        <h4 id="sonstige-affiliate-partner-programme">
        ...
        <h2 id="9.-audio-und-videokonferenzen">9. Audio- und Videokonferenzen</h2>
        <h4 id="datenverarbeitung">Datenverarbeitung</h4>
        <p>
        ...
        <p>
          ...
          Gerätetyp, Betriebssystemtyp und -version, Client-Version, Kameratyp, Mikrofon oder Lautsprecher sowie die Art
          der Verbindung.
        </p>
        <p>
          Sofern innerhalb des Tools Inhalte ausgetauscht, hochgeladen oder in sonstiger Weise bereitgestellt werden,
          werden diese ebenfalls auf den Servern der Tool-Anbieter gespeichert. Zu solchen Inhalten zählen insbesondere
          Cloud-Aufzeichnungen, Chat-/ Sofortnachrichten, Voicemails hochgeladene Fotos und Videos, Dateien, Whiteboards
          und andere Informationen, die während der Nutzung des Dienstes geteilt werden.
        </p>
        <p>
          Bitte beachten Sie, dass wir nicht vollumfänglich Einfluss auf die Datenverarbeitungsvorgänge der verwendeten
        ...
        <h4 id="zweck-und-rechtsgrundlagen">Zweck und Rechtsgrundlagen</h4>
        <p>
        ...
        <h4 id="speicherdauer">Speicherdauer</h4>
        <p>
          Die unmittelbar von uns über die Video- und Konferenz-Tools erfassten Daten werden von unseren Systemen
          gelöscht, sobald Sie uns zur Löschung auffordern, Ihre Einwilligung zur Speicherung widerrufen oder der Zweck
          für die Datenspeicherung entfällt. Gespeicherte Cookies verbleiben auf Ihrem Endgerät, bis Sie sie löschen.
        ...
        <h4 id="eingesetzte-konferenz-tools">Eingesetzte Konferenz-Tools</h4>
        ...
        <p>
          ...
          6th Floor, San Jose, CA 95113, USA. Details zur Datenverarbeitung entnehmen Sie der Datenschutzerklärung von
          Zoom:{" "}
          <a
        ...
        <p>
          Wir nutzen TeamViewer. Anbieter ist die TeamViewer Germany GmbH, Jahnstr. 30, 73037 Göppingen. Details zur
          Datenverarbeitung entnehmen Sie der Datenschutzerklärung von TeamViewer:{" "}
          <a
        ...
        <h3 id="gotomeeting">GoToMeeting</h3>
        <p>
          Wir nutzen GoToMeeting. Anbieter ist die LogMeIn, Inc., 320 Summer Street Boston, MA 02210, USA. Details zur
          Datenverarbeitung entnehmen Sie der Datenschutzerklärung von GoToMeeting:{" "}
          <a
        ...
        <p>
          Wir nutzen Microsoft Teams. Anbieter ist die Microsoft Corporation, One Microsoft Way, Redmond, WA 98052-6399,
          USA. Details zur Datenverarbeitung entnehmen Sie der Datenschutzerklärung von Microsoft Teams:{" "}
          <a
        ...
        <p>
          Wir nutzen Google Hangouts. Anbieter ist die Google Ireland Limited, Gordon House, Barrow Street, Dublin 4,
          Irland. Details zur Datenverarbeitung entnehmen Sie der Datenschutzerklärung von Google Hangouts:{" "}
          <a
            href="https://policies.google.com/privacy?hl=de"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <h2 id="10.-eigene-dienste">10. Eigene Dienste</h2>
        <h3 id="onedrive">OneDrive</h3>
        <p>
          Wir haben OneDrive auf dieser Website eingebunden. Anbieter ist die Microsoft Corporation, One Microsoft Way,
          Redmond, WA 98052-6399, USA (im folgenden „OneDrive“).
        </p>
        <p>
          OneDrive ermöglicht es uns, einen Uploadbereich auf unserer Website einzubinden, in dem Sie Inhalte hochladen
        ...
        <p>
          Die Verwendung von OneDrive erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein
